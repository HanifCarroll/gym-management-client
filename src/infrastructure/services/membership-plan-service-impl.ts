...
export class MembershipPlanServiceImpl implements MembershipPlanService {
  ...
  constructor(membershipPlanRepository: MembershipPlanRepository = new ApiMembershipPlanRepository()) {
  ...
  async createMembershipPlan(plan: CreateMembershipPlanData): Promise<MembershipPlan> {
    return this.membershipPlanRepository.create(plan);
  }

  async updateMembershipPlan(id: string, plan: UpdateMembershipPlanData): Promise<MembershipPlan> {
